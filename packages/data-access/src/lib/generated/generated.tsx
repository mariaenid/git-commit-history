...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'LoginResult', access_token: string, user: { __typename?: 'User', id?: string | null, name?: string | null, email?: string | null } } };
...
export const RegisterDocument = gql`
    mutation register($password: String!, $email: String!, $lastName: String!, $name: String!) {
  register(password: $password, email: $email, lastName: $lastName, name: $name) {
    access_token
    user {
      id
      name
